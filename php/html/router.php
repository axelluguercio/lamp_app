...
$router->setDefaultRoute('marcaController', 'showAllMarcas');
...
$router->addRoute('insertar_auto', 'POST', 'autoController', 'handlerCreateAuto');
...
$router->addRoute('modificar_auto', 'POST', 'autoController', 'handlerModifyAuto');
$router->addRoute('borrar_img/:ID', 'GET', 'autoController', 'deleteImage');
/*/ Usuarios /*/
