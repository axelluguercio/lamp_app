...
class autoView {
    ...
    function showAutos($autos, $pag=null, $message=null) {
		// Titulo
		...
		$this->smarty_for_auto->assign('buttons', true);
		// pasa la cant de paginas
		$this->smarty_for_auto->assign('pag', $pag);
		if (isset($message)) 
		$this->smarty_for_auto->assign('message', $message);
		// renderizo el template
